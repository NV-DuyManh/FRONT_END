...
// kiem theo queryselectAll =>
let b = document.querySelectorAll(".grapes .col");
console.log(b);
...
// kiem theo className 
let d = document.getElementsByClassName("fa-car-side");
console.log(d);

let listCol = document.querySelectorAll(".grapes .col img"); // array 

let c_red = document.getElementsByTagName("h1");
Array.from(c_red).forEach(s => {
...
let input = document.querySelector(".grapes");
listAnh.forEach(s => {
